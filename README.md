...
* If your model is not in the list you have to make your own build following the steps in the [documentation](https://github.com/xchwarze/wifi-pineapple-cloner).
